...
export const FileFieldItemDeleteTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <FileFieldPrimitive.ItemDeleteTrigger
      ...
      class={cx(
        "focus-visible:ring-destructive/50 cursor-pointer self-center rounded-sm p-0.5 outline-none transition-[color,box-shadow] [grid-area:delete] focus-visible:ring-[1.5px] [&_svg:not([class*='size-'])]:size-4",
        props.class,
      )}
      {...rest}
    >
