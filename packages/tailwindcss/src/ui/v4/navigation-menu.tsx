...
export const NavigationMenu = <T extends ValidComponent = "ul">(
  ...
  const [local, rest] = splitProps(merge, ["class", "children"])
...
export const NavigationMenuItem = <T extends ValidComponent = "a">(
  ...
  const [local, rest] = splitProps(props as NavigationMenuItemProps, ["class"])
...
export const NavigationMenuTrigger = <T extends ValidComponent = "button">(
  ...
  const [local, rest] = splitProps(props as NavigationMenuTriggerProps, [
    "class",
    "children",
  ])
...
export const NavigationItemLabel = <T extends ValidComponent = "div">(
  ...
  const [local, rest] = splitProps(props as NavigationItemLabelProps, ["class"])

  return (
    <NavigationMenuPrimitive.ItemLabel
      data-slot="navigation-menu-label"
      class={cx("text-sm font-medium leading-none", local.class)}
      {...rest}
    />
  )
}
...
export const NavigationItemDescription = <T extends ValidComponent = "div">(
  ...
  const [local, rest] = splitProps(props as NavigationItemDescriptionProps, [
    "class",
  ])
