  ...
  return (
    <AccordionPrimitive.Header class="flex" as="div">
      <AccordionPrimitive.Trigger
        class={cn(
          "focus-visible:(outline-none ring-1.5 ring-ring) flex flex-1 items-center justify-between bg-inherit py-4 text-sm font-medium transition-shadow hover:underline [&[data-expanded]>svg]:rotate-180",
          local.class
        )}
        {...rest}
      >
