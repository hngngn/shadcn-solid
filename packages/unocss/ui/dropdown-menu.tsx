  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        class={cn(
          "min-w-8rem bg-popover text-popover-foreground data-[expanded]:(animate-in fade-in-0 zoom-in-95) data-[closed]:(animate-out fade-out-0 zoom-out-95) focus-visible:(outline-none ring-1.5 ring-ring) z-50 overflow-hidden rounded-md border p-1 shadow-md transition-shadow",
          local.class
        )}
        {...rest}
      />
...
export const DropdownMenuItem = <T extends ValidComponent = "div">(
  ...
  return (
    <DropdownMenuPrimitive.Item
      class={cn(
        "focus:(bg-accent text-accent-foreground) data-[disabled]:(pointer-events-none opacity-50) relative flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none transition-colors",
        local.inset && "pl-8",
        local.class
      )}
      {...rest}
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.SubContent
        class={cn(
          "min-w-8rem bg-popover text-popover-foreground data-[expanded]:(animate-in fade-in-0 zoom-in-95) data-[closed]:(animate-out fade-out-0 zoom-out-95) z-50 overflow-hidden rounded-md border p-1 shadow-md",
          local.class
        )}
        {...rest}
      />
...
export const DropdownMenuCheckboxItem = <T extends ValidComponent = "div">(
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      class={cn(
        "focus:(bg-accent text-accent-foreground) data-[disabled]:(pointer-events-none opacity-50) relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none transition-colors",
        local.class
      )}
      {...rest}
    >
