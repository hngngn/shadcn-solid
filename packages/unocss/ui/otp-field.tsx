...
export const OTPFieldSlot = (
  ...
  return (
    <div
      class={cn(
        "border-input first:(rounded-l-md border-l) relative flex size-9 items-center justify-center border-y border-r text-sm shadow-sm transition-all last:rounded-r-md",
        isActive() && "ring-1.5 ring-ring z-10",
        local.class
      )}
      {...rest}
    >
