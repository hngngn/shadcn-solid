...
export const Pagination = <T extends ValidComponent = "nav">(
  ...
  return (
    <PaginationPrimitive
      class={cn(
        "[&>ul]:(flex gap-1) mx-auto flex w-full flex-row items-center justify-center",
        local.class
      )}
      {...rest}
    />
  ...
  return (
    <PaginationPrimitive.Item
      class={cn(
        ...
        "aria-[current=page]:(border border-input bg-background hover:bg-accent hover:text-accent-foreground) shadow-sm",
        local.class
      )}
      {...rest}
    />
