...
export const NavigationMenuTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      class={cn(
        "bg-background hover:(bg-accent text-accent-foreground) disabled:(pointer-events-none opacity-50) inline-flex w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium outline-none transition-colors duration-300",
        local.class
      )}
      {...rest}
    >
