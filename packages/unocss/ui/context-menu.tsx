  ...
  return (
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.SubContent
        class={cn(
          "bg-popover text-popover-foreground data-[expanded]:(animate-in fade-in-0 zoom-in-95) data-[closed]:(animate-out fade-out-0 zoom-out-95) z-50 min-w-[8rem] overflow-hidden rounded-md border p-1 shadow-lg",
          local.class
        )}
        {...rest}
      />
  ...
  return (
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        class={cn(
          "bg-popover text-popover-foreground data-[expanded]:(animate-in fade-in-0 zoom-in-95) data-[closed]:(animate-out fade-out-0 zoom-out-95) focus-visible:(outline-none ring-1.5 ring-ring) z-50 min-w-[8rem] overflow-hidden rounded-md border p-1 shadow-md transition-shadow",
          local.class
        )}
        {...rest}
      />
