...
export const Index: Record<string, any> = {
   "tailwindcss": { 
		...
		"bar-chart-multiply": {
			...
			registryDependencies: ["card","chart"],
			files: [{
				path: "src/registry/tailwindcss/charts/bar-chart-multiply.tsx",
				type: "registry:block",
				target: "",
			...
			component: clientOnly(() => import("@/registry/tailwindcss/charts/bar-chart-multiply"), { lazy: true }),
			source: "src/__registry__/tailwindcss/charts/bar-chart-multiply.tsx",
			category: "",
			subcategory: ""
		}, 
		"bar-chart-stacked": {
