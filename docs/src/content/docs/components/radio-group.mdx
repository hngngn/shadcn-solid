...
<Fragment slot="code">
```tsx file=<rootDir>/src/examples/radio-group-demo.tsx
```
</Fragment>
</ComponentPreview>
...
```tsx file=<rootDir>/node_modules/@repo/tailwindcss/ui/radio-group.tsx
```
...
<StepItem>Copy and paste the following code into your project:</StepItem>
```tsx file=<rootDir>/node_modules/@repo/unocss/ui/radio-group.tsx
```
