...
<Fragment slot="code">
```tsx file=<rootDir>/src/examples/accordion-demo.tsx
```
</Fragment>
</ComponentPreview>
...
```tsx file=<rootDir>/node_modules/@repo/tailwindcss/ui/accordion.tsx
```
...
<StepItem>Copy and paste the following code into your project:</StepItem>
```tsx file=<rootDir>/node_modules/@repo/unocss/ui/accordion.tsx
```
