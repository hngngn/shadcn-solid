...
import DemoCode from "@/examples/accordion-demo?raw";
import TwRawCode from "@repo/tailwindcss/ui/accordion?raw";
import UnoRawCode from "@repo/unocss/ui/accordion?raw";

<ComponentPreview name="accordion-demo" code={DemoCode} client:only="solid-js" />
