...
```tsx file=<rootDir>/node_modules/@repo/tailwindcss/ui/otp-field.tsx
```
...
<StepItem>Copy and paste the following code into your project:</StepItem>
```tsx file=<rootDir>/node_modules/@repo/unocss/ui/otp-field.tsx
```
...
<ComponentPreview name="otp-field-with-pattern-demo" client:only="solid-js">
<Fragment slot="code">
```tsx file=<rootDir>/src/examples/otp-field-with-pattern-demo.tsx
```
</Fragment>
</ComponentPreview>
...
<ComponentPreview name="otp-field-with-controlled-demo" client:only="solid-js">
<Fragment slot="code">
```tsx file=<rootDir>/src/examples/otp-field-ưith-controlled-demo.tsx
```
</Fragment>
</ComponentPreview>