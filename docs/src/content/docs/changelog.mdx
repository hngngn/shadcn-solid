...
import CalendarDemo from "@/examples/default/tailwindcss/calendar-demo?raw";
import CarouselDemo from "@/examples/default/tailwindcss/carousel-demo?raw";
import CommandDemo from "@/examples/default/tailwindcss/command-demo?raw";
import DatePickerDemo from "@/examples/default/tailwindcss/date-picker-demo?raw";
import MenubarDemo from "@/examples/default/tailwindcss/menubar-demo?raw";
import NumberFieldDemo from "@/examples/default/tailwindcss/number-field-demo?raw";
import OTPFieldDemo from "@/examples/default/tailwindcss/otp-field-demo?raw";
import PaginationDemo from "@/examples/default/tailwindcss/pagination-demo?raw";
import SonnerDemo from "@/examples/default/tailwindcss/sonner-demo?raw";
import ToggleGroupDemo from "@/examples/default/tailwindcss/toggle-group-demo?raw";
...
<ComponentPreview name="number-field-demo" code={NumberFieldDemo} client:only="solid-js" />
...
<ComponentPreview name="otp-field-demo" code={OTPFieldDemo} client:only="solid-js" />

### Menubar

A visually persistent menu common in desktop applications that provides quick access to a consistent set of commands.

<ComponentPreview name="menubar-demo" code={MenubarDemo} client:only="solid-js" />

### Calendar

New `Calendar` demo.

<ComponentPreview name="calendar-demo" code={CalendarDemo} client:only="solid-js" />
...
<ComponentPreview name="toggle-group-demo" code={ToggleGroupDemo} client:only="solid-js" />

### Sonner

<ComponentPreview name="sonner-demo" code={SonnerDemo} client:only="solid-js" />
...
<ComponentPreview name="date-picker-demo" code={DatePickerDemo} client:only="solid-js" />

### Command

<ComponentPreview name="command-demo" code={CommandDemo} client:only="solid-js" />
...
<ComponentPreview name="carousel-demo" code={CarouselDemo} client:only="solid-js" />

### Pagination

We've added a pagination component with page navigation, previous and next buttons. Simple and flexible.

<ComponentPreview name="pagination-demo" code={PaginationDemo} client:only="solid-js" />
