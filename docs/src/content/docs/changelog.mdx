...
<ComponentPreview name="number-field-demo" code={NumberFieldDemo} client:only="solid" />
...
<ComponentPreview name="otp-field-demo" code={OTPFieldDemo} client:only="solid" />

### Menubar

A visually persistent menu common in desktop applications that provides quick access to a consistent set of commands.

<ComponentPreview name="menubar-demo" code={MenubarDemo} client:only="solid" />

### Calendar

New `Calendar` demo.

<ComponentPreview name="calendar-demo" code={CalendarDemo} client:only="solid" />
...
<ComponentPreview name="toggle-group-demo" code={ToggleGroupDemo} client:only="solid" />

### Sonner

<ComponentPreview name="sonner-demo" code={SonnerDemo} client:only="solid" />
...
<ComponentPreview name="date-picker-demo" code={DatePickerDemo} client:only="solid" />

### Command

<ComponentPreview name="command-demo" code={CommandDemo} client:only="solid" />
...
<ComponentPreview name="carousel-demo" code={CarouselDemo} client:only="solid" />

### Pagination

We've added a pagination component with page navigation, previous and next buttons. Simple and flexible.

<ComponentPreview name="pagination-demo" code={PaginationDemo} client:only="solid" />
