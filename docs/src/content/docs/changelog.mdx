...
import CalendarDemo from "@/examples/calendar-demo?raw";
import CarouselDemo from "@/examples/carousel-demo?raw";
import CommandDemo from "@/examples/command-demo?raw";
import DatePickerDemo from "@/examples/date-picker-demo?raw";
import MenubarDemo from "@/examples/menubar-demo?raw";
import NumberFieldDemo from "@/examples/number-field-demo?raw";
import OTPFieldDemo from "@/examples/otp-field-demo?raw";
import PaginationDemo from "@/examples/pagination-demo?raw";
import SonnerDemo from "@/examples/sonner-demo?raw";
import ToggleGroupDemo from "@/examples/toggle-group-demo?raw";
import NavigationMenuDemo from "@/examples/navigation-menu-demo?raw";
...
<ComponentPreview name="navigation-menu-demo" code={NavigationMenuDemo} client:only="solid-js" />
