...
A collection of chart components that you can copy and paste into your apps. Built using [Unovis](https://unovis.dev/).

Learn more about [Chart](/charts).

### Sidebar

<figure className="mt-4 flex flex-col gap-4">
...
- Blocks are ready-made components that you can use to build your apps. They are fully responsive, accessible, and composable, meaning they are built using the same principles as the rest of the components in shadcn-solid.
...
- Update dependency from [`solid-sonner`](https://github.com/wobsoriano/solid-sonner) to [`somoto`](https://github.com/Oc1S/somo) for SSR compatibility.
...
```tsx file=<rootDir>/src/registry/tailwindcss/examples/navigation-menu-demo.tsx
```
</ComponentPreview>
...
```tsx file=<rootDir>/src/registry/tailwindcss/examples/calendar-demo.tsx
```
</ComponentPreview>
...
```tsx file=<rootDir>/src/registry/tailwindcss/examples/toggle-group-demo.tsx
```
</ComponentPreview>
...
```tsx file=<rootDir>/src/registry/tailwindcss/examples/date-picker-demo.tsx
```
</ComponentPreview>
...
```tsx file=<rootDir>/src/registry/tailwindcss/examples/carousel-demo.tsx
```
</ComponentPreview>
...
```tsx file=<rootDir>/src/registry/tailwindcss/examples/pagination-demo.tsx
```
</ComponentPreview>
