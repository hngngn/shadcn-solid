...
```tsx file=<rootDir>/src/registry/tailwindcss/examples/data-table-demo.tsx
...
```tsx title="src/routes/_components/data-table.tsx" {4,6,10,14-15,17-19,25-32}
//...
import {
  //...
  getFilteredRowModel,
...
```tsx title="src/routes/_components/data-table.tsx" {2-9,13,17,20-22,30-54}
//...
