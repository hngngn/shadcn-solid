...
```tsx file=<rootDir>/src/registry/tailwindcss/ui/carousel.tsx
```
...
```tsx file=<rootDir>/src/registry/tailwindcss/examples/carousel-size.tsx
...
```tsx file=<rootDir>/src/registry/tailwindcss/examples/carousel-spacing.tsx
...
```tsx file=<rootDir>/src/registry/tailwindcss/examples/carousel-orientation.tsx
...
```tsx file=<rootDir>/src/registry/tailwindcss/examples/carousel-api-demo.tsx
...
```tsx file=<rootDir>/src/registry/tailwindcss/examples/carousel-plugin.tsx
