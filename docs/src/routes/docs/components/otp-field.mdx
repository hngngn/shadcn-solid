...
```tsx file=<rootDir>/../packages/tailwindcss/examples/otp-field-with-pattern-demo.tsx
```
...
```tsx file=<rootDir>/../packages/tailwindcss/examples/otp-field-with-controlled-demo.tsx
```
