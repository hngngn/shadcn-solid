---
title: Theming
description: Using CSS Variables or your choice of CSS frameworks for theming.
---

You can choose between using CSS variables or your choice of CSS frameworks utility classes for theming.
...
```css title="Border color for inputs such as <TextField />, <Select />, <Textarea />"
