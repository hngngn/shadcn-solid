  ...
  return (
    <div class="flex w-full items-center gap-2">
      ...
      <div class="ml-auto flex items-center gap-2">
        <Button
          variant="ghost"
          class="hidden h-7 w-7 gap-2 rounded-md border bg-transparent shadow-none md:flex lg:w-auto"
          size="sm"
      ...
      <div class="grid w-full gap-4">
        <Resizable sizes={sizes()} onSizesChange={setSizes}>
          <ResizablePanel
            initialSize={1}
            minSize={0.3}
            class="bg-background relative aspect-[4/2.5] overflow-hidden rounded-xl border md:aspect-auto"
          >
            <img
            ...
            <iframe
              ...
              class="bg-background hidden w-full md:block"
              title={item()?.name}
              loading="lazy"
            />
          </ResizablePanel>
          <ResizableHandle class="after:bg-border hidden w-3 bg-transparent p-0 after:absolute after:right-0 after:top-1/2 after:h-8 after:w-[6px] after:-translate-y-1/2 after:translate-x-[-1px] after:rounded-full after:transition-all after:hover:h-10 md:block" />
