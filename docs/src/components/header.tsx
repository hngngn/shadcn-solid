...
import ModeToggle from "@/registry/tailwindcss/examples/mode-toggle";
...
export const Header = () => {
	return (
		<header class="sticky top-0 z-50 w-full border-b border-border/40 dark:border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
