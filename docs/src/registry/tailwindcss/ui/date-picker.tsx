...
export const DatePickerViewTrigger = (props: DatePickerViewTriggerProps) => {
  ...
  return (
    <DatePickerPrimitive.ViewTrigger
      class={cn(buttonVariants({ variant: "ghost" }), "mx-2 h-7", local.class)}
      {...rest}
    />
  )
}
...
export const DatePickerContent = (props: DatePickerContentProps) => {
  ...
  return (
    <DatePickerPrimitive.Content
      class={cn(
        "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 z-50 rounded-md border p-3 shadow-md outline-none",
        local.class
      )}
      {...rest}
    >
...
export const DatePickerInput = (props: DatePickerInputProps) => {
  ...
  return (
    <DatePickerPrimitive.Input
      class={cn(
        "border-border bg-background placeholder:text-muted-foreground focus-visible:ring-ring h-9 w-full border px-3 py-1 text-sm shadow-sm transition-shadow focus-visible:outline-none focus-visible:ring-[1.5px] disabled:cursor-not-allowed disabled:opacity-50",
        local.class
      )}
      {...rest}
    />
...
export const DatePickerTrigger = (props: DatePickerTriggerProps) => {
  ...
  return (
    <DatePickerPrimitive.Trigger
      class={cn(
        "focus-visible:ring-ring border-border bg-background hover:bg-accent/50 flex min-h-9 min-w-9 items-center justify-center rounded-e-md border transition-[box-shadow,background-color] focus-visible:outline-none focus-visible:ring-[1.5px] disabled:cursor-not-allowed disabled:opacity-50 [&>svg]:size-4",
        local.class
      )}
      {...rest}
    >
