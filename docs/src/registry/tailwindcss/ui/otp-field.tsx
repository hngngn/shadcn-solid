...
export const OTPFieldSlot = (
  ...
  return (
    <div
      class={cn(
        "border-input relative flex size-9 items-center justify-center border-y border-r text-sm shadow-sm transition-shadow first:rounded-l-md first:border-l last:rounded-r-md",
