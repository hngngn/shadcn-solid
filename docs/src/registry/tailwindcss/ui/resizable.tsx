...
export const ResizableHandle = <T extends ValidComponent = "button">(
  ...
  return (
    <ResizablePrimitive.Handle
      class={cn(
        "bg-border focus-visible:ring-ring flex w-px items-center justify-center transition-shadow focus-visible:outline-none focus-visible:ring-[1.5px] focus-visible:ring-offset-1 data-[orientation=vertical]:h-px data-[orientation=vertical]:w-full",
        local.class
      )}
      {...rest}
    >
