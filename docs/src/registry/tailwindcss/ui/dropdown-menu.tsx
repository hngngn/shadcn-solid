  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        class={cn(
          "min-w-8rem bg-popover text-popover-foreground focus-visible:ring-ring data-[expanded]:animate-in data-[closed]:animate-out data-[closed]:fade-out-0 data-[expanded]:fade-in-0 data-[closed]:zoom-out-95 data-[expanded]:zoom-in-95 z-50 overflow-hidden rounded-md border p-1 shadow-md transition-shadow focus-visible:outline-none focus-visible:ring-[1.5px]",
          local.class
        )}
        {...rest}
      />
