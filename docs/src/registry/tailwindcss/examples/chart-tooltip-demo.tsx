import { ComponentProps, For, Show, mergeProps } from "solid-js"
...
const ChartTooltipDemo = () => {
  return (
    <div class="text-foreground grid aspect-video w-full max-w-md justify-center md:grid-cols-2 [&>div]:relative [&>div]:flex [&>div]:h-[137px] [&>div]:w-[224px] [&>div]:items-center [&>div]:justify-center [&>div]:p-4">
      <div>
