...
<ComponentPreview name="carousel-demo" code={DemoCode} client:only="solid" />
...
<ComponentPreview name="carousel-size" code={DemoCode2} client:only="solid" />
...
<ComponentPreview name="carousel-spacing" code={DemoCode3} client:only="solid" />
...
<ComponentPreview name="carousel-orientation" code={DemoCode4} client:only="solid" />
...
<ComponentPreview name="carousel-api-demo" code={DemoCode5} client:only="solid" />
...
<ComponentPreview name="carousel-plugin" code={DemoCode6} client:only="solid" />
