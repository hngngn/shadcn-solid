...
import { type ParentProps, Show, type ValidComponent, mergeProps, splitProps } from "solid-js";
    ...
    >
      ...
      <NavigationMenuPrimitive.Viewport
        class={cn(
          ...
          // "origin-[--kb-menu-content-transform-origin] transition-[width,height] duration-300",
          // "data-[expanded]:pointer-events-auto data-[expanded]:duration-300 data-[expanded]:animate-in data-[expanded]:fade-in data-[expanded]:zoom-in-95",
          // "data-[closed]:duration-300 data-[closed]:animate-out data-[closed]:fade-out data-[closed]:zoom-out-90",
        )}
      >
...
type navigationMenuTriggerProps<T extends ValidComponent = "button"> = ParentProps<
...
export const NavigationMenuContent = <T extends ValidComponent = "ul">(
  ...
  const [local, rest] = splitProps(props as navigationMenuContentProps, ["class", "children"]);
    ...
    <NavigationMenuPrimitive.Portal>
      <NavigationMenuPrimitive.Content
        class={cn(
          ...
          "[&:is([data-motion=^=from-][data-expanded])]:animate-in [&:is([data-motion=^=from-][data-expanded])]:fade-in",
          "[&:is([data-motion=^=to-][data-closed])]:animate-out [&:is([data-motion=^=to-][data-closed])]:fade-out",
          local.class
        )}
        {...rest}
      >
