...
## May 2024 - CLI and Component updates
...
Transitioned two existing components, [**Splitter**](components/resizable) and [**Command**](components/command), to utilize the new Resizable from [corvu](https://corvu.dev) and the solid port from [cmdk](https://cmdk-solid.vercel.app), respectively.
...
- [**Splitter**](#splitter) - A component that divides your interface into resizable sections.
- [**Drawer**](#drawer) - A draggable dialog that is attached to any side of the viewport.

### Splitter

Build resizable sections with this `<Splitter />` component.

Built on top of [Splitter](https://ark-ui.com/docs/components/splitter) component from [Ark UI](https://ark-ui.com).
