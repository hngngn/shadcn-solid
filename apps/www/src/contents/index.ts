...
> = {
  ...
  "/docs/components/alert-dialog": {
    component: lazy(
      () => import("@/contents/docs/components/alert-dialog.mdx"),
    ),
  },
  ...
  "/docs/components/context-menu": {
    component: lazy(
      () => import("@/contents/docs/components/context-menu.mdx"),
    ),
  },
  ...
  "/docs/components/dropdown-menu": {
    component: lazy(
      () => import("@/contents/docs/components/dropdown-menu.mdx"),
    ),
  },
  ...
  "/docs/components/toggle-group": {
    component: lazy(
      () => import("@/contents/docs/components/toggle-group.mdx"),
    ),
  },
  ...
  "/docs/installation/solid-start": {
    component: lazy(
      () => import("@/contents/docs/installation/solid-start.mdx"),
    ),
  },
  "/docs/theming": {
