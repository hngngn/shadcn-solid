...
import NavMain from "@/registry/blocks/sidebar-01/components/nav-main"
import NavUser from "@/registry/blocks/sidebar-01/components/nav-user"
import TeamSwitcher from "@/registry/blocks/sidebar-01/components/team-switcher"
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
const data = {
  ...
  components: Object.values(Index.unocss)
    .filter(
      (item: any) => item.type === "registry:ui" && item.name !== "sidebar",
    )
    .concat([
      {
        name: "date-picker",
        ...
        <SidebarGroup class="group-data-[collapsible=icon]:hidden">
          ...
          <SidebarMenu>
            <For each={data.components}>
              {(item) => (
                <SidebarMenuItem>
                  <SidebarMenuButton as="a" href={`#${item.name}`}>
