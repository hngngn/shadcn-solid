...
export const Contents: Record<string, Content> = {
  ...
  "components/dropdown-menu": {
    component: lazy(
      () => import("@/content/docs/components/dropdown-menu.mdx"),
    ),
    data: {
      title: "Dropdown Menu",
      description:
  ...
  "components/navigation-menu": {
    component: lazy(
      () => import("@/content/docs/components/navigation-menu.mdx"),
    ),
    data: {
  ...
  "components/segmented-control": {
    component: lazy(
      () => import("@/content/docs/components/segmented-control.mdx"),
    ),
    data: {
  ...
  "components/toggle-button": {
    component: lazy(
      () => import("@/content/docs/components/toggle-button.mdx"),
    ),
    data: {
      title: "Toggle Button",
  ...
  installation: {
    ...
    data: {
      title: "Installation",
      description:
        "How to install dependencies and get required component for your app.",
    },
    headings: [
      {
        depth: 3,
  ...
  introduction: {
    ...
    data: {
      title: "Introduction",
      description:
        "Re-usable components built using Kobalte UI and your choice of CSS frameworks.",
    },
    headings: [
      {
        depth: 2,
