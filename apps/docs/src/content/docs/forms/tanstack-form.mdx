...
```tsx file=<rootDir>/src/registry/examples/tanstack-form-demo.tsx
...
```tsx title="form" file=<rootDir>/src/registry/examples/tanstack-form-demo.tsx
...
```tsx file=<rootDir>/src/registry/examples/tanstack-form-input-demo.tsx
...
```tsx file=<rootDir>/src/registry/examples/tanstack-form-textarea-demo.tsx
...
```tsx file=<rootDir>/src/registry/examples/tanstack-form-select-demo.tsx
...
```tsx file=<rootDir>/src/registry/examples/tanstack-form-checkbox-demo.tsx
...
```tsx file=<rootDir>/src/registry/examples/tanstack-form-radio-group-demo.tsx
...
```tsx file=<rootDir>/src/registry/examples/tanstack-form-switch-demo.tsx
