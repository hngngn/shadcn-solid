...
```tsx file=<rootDir>../../../packages/tailwindcss/src/examples/data-table-demo.tsx
...
```tsx title="src/routes/index.tsx" {29}
...
```tsx title="src/routes/_components/columns.tsx" {2-7,11-37}
//...
import {
  DropdownMenu,
  DropdownMenuContent,
...
```tsx title="src/routes/_components/data-table.tsx" {4-5,11,15-16,19-21,27-40}
//...
import {
  //...
  ColumnFiltersState,
...
```tsx title="src/routes/_components/data-table.tsx" {4,19-21,25,28-30,38-63}
//...
import {
  //...
  VisibilityState,
