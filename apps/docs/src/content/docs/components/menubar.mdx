...
```tsx file=<rootDir>/src/registry/examples/menubar-demo.tsx
...
<StepItem>Copy and paste the following code into your project:</StepItem>
  ...
  <ComponentSourceTabs>
    ...
    ```tsx title="components/ui/menubar" file=<rootDir>/src/registry/ui/menubar.tsx

    ```

    ```tsx title="components/ui/menubar" file=<rootDir>../../unocss-playground/src/registry/ui/menubar.tsx
