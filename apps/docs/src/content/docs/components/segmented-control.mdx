...
```tsx file=<rootDir>/src/registry/examples/segmented-control-demo.tsx
...
<ComponentInstallation>
  ...
  <Step>
    ...
    ```tsx title="components/ui/segmented-control" file=<rootDir>/src/registry/ui/segmented-control.tsx

    ```

    ```tsx title="components/ui/segmented-control" file=<rootDir>../../unocss-playground/src/registry/ui/segmented-control.tsx
...
```tsx file=<rootDir>/src/registry/examples/segmented-control-orientation-demo.tsx
