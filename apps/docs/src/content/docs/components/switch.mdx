...
```tsx file=<rootDir>/src/registry/examples/switch-demo.tsx
...
<StepItem>Copy and paste the following code into your project:</StepItem>
  ...
  <ComponentSourceTabs>
    ...
    ```tsx title="components/ui/switch" file=<rootDir>/src/registry/ui/switch.tsx

    ```

    ```tsx title="components/ui/switch" file=<rootDir>../../unocss-playground/src/registry/ui/switch.tsx
