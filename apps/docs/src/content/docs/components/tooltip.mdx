...
```tsx file=<rootDir>/src/registry/examples/tooltip-demo.tsx
...
<StepItem>Copy and paste the following code into your project:</StepItem>
  ...
  <ComponentSourceTabs>
    ...
    ```tsx title="components/ui/tooltip" file=<rootDir>/src/registry/ui/tooltip.tsx

    ```

    ```tsx title="components/ui/tooltip" file=<rootDir>../../unocss-playground/src/registry/ui/tooltip.tsx
