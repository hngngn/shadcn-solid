...
<StepItem>Copy and paste the following code into your project:</StepItem>
  ...
  <ComponentSourceTabs>
    ...
    ```tsx title="components/ui/sidebar" file=<rootDir>/src/registry/ui/sidebar.tsx

    ```

    ```tsx title="components/ui/sidebar" file=<rootDir>../../unocss-playground/src/registry/ui/sidebar.tsx
