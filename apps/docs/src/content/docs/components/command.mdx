...
```tsx file=<rootDir>/src/registry/examples/command-demo.tsx
...
<StepItem>Copy and paste the following code into your project:</StepItem>
  ...
  <ComponentSourceTabs>
    ...
    ```tsx title="components/ui/command" file=<rootDir>/src/registry/ui/command.tsx

    ```

    ```tsx title="components/ui/command" file=<rootDir>../../unocss-playground/src/registry/ui/command.tsx
...
```tsx file=<rootDir>/src/registry/examples/command-dialog-demo.tsx
