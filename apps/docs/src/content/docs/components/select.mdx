...
```tsx file=<rootDir>../../../packages/tailwindcss/src/examples/select-demo.tsx
...
```
  ...
  <Step>
    ...
    <ComponentSource>
      ...
      ```tsx title="components/ui/select" file=<rootDir>../../../packages/tailwindcss/src/ui/v4/select.tsx
...
```tsx file=<rootDir>../../../packages/tailwindcss/src/examples/select-error-demo.tsx
