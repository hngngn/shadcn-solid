...
```tsx file=<rootDir>/src/registry/examples/calendar-demo.tsx
...
<StepItem>Copy and paste the following code into your project:</StepItem>
  ...
  <ComponentSourceTabs>
    ...
    ```tsx title="components/ui/calendar" file=<rootDir>/src/registry/ui/calendar.tsx

    ```

    ```tsx title="components/ui/calendar" file=<rootDir>../../unocss-playground/src/registry/ui/calendar.tsx
...
```tsx file=<rootDir>/src/registry/examples/calendar-range-demo.tsx
