...
```tsx file=<rootDir>/src/registry/examples/skeleton-demo.tsx
...
<StepItem>Copy and paste the following code into your project:</StepItem>
  ...
  <ComponentSourceTabs>
    ...
    ```tsx title="components/ui/skeleton" file=<rootDir>/src/registry/ui/skeleton.tsx

    ```

    ```tsx title="components/ui/skeleton" file=<rootDir>../../unocss-playground/src/registry/ui/skeleton.tsx
