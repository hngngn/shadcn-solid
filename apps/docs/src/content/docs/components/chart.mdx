...
<ComponentPreview
  ...
  class="[&_.preview]:block [&_.preview]:overflow-hidden [&_.preview]:border-t [&_.preview]:p-0 [&_.preview]:lg:min-h-[404px] [&_.preview>div]:rounded-none [&_.preview>div]:border-none [&_.preview>div]:shadow-none [&_.preview>div:not(:has(table))]:sm:max-w-full"
  hideCode
/>
...
<StepItem>Copy and paste the following code into your project:</StepItem>
  ...
  <ComponentSource>
    ...
    ```tsx title="components/ui/chart" file=<rootDir>../../../packages/tailwindcss/src/ui/v4/chart.tsx
